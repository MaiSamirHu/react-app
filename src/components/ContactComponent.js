                    ...
                    <Form model="feedback" onSubmit={(values)=>this.handleSubmit(values)}>
                        <Row className="form-group">
                            ...
                            <Col md={10}>
                                ...
                                messages={{
                                    required :'Required',
                                    minLen :'must be greater than two characters',
                        ...
                        <Row className="form-group">
                            ...
                            <Col md={10}>
                                ...
                                placeholder="Tel. No" 
                                validators={{required,minLen :minLen(3),maxLen: maxLen(15),isNumber}}
                                />
                        ...
                        <Row className="form-group">
                            ...
                            <Col md={10}>
                                <Control.textarea  model=".message" row="12" id="message"   name="message"  className="form-control"/>
                            </Col>
                        </Row>
